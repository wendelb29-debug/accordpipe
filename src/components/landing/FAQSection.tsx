...
const faqs = [
  ...
  { question: "Como funciona o pagamento automático?", answer: "Integramos com a Kiwify para processar pagamentos via PIX, boleto e cartão de crédito. Quando o pagamento é confirmado, o sistema atualiza automaticamente o status financeiro." },
  { question: "Quais integrações o ORBIT HUB oferece?", answer: "O sistema integra com WhatsApp (Z-API e Evolution API), Kiwify para pagamentos, e possui IA integrada para automações inteligentes. Novas integrações são adicionadas constantemente." },
];
