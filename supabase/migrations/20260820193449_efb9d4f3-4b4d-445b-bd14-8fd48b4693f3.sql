...
REVOKE ALL ON FUNCTION public.get_company_integration_credentials(uuid) FROM public, anon;
GRANT EXECUTE ON FUNCTION public.get_company_integration_credentials(uuid) TO authenticated;